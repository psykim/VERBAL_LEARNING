...
const VerbalLearningTestCalculator = () => {
  ...
  const renderWordGrid = (wordList, trial, columns = 4) => {
    ...
    // 동적 Tailwind 클래스 문제 해결
    const gridClass = columns === 4 ? 'grid-cols-4' : columns === 5 ? 'grid-cols-5' : 'grid-cols-3';
    
    return (
      <div className={`grid ${gridClass} gap-2 p-3 border rounded bg-gray-50`}>
...
export default VerbalLearningTestCalculator;